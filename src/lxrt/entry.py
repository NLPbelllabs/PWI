...
class LXRTEncoder(nn.Module):
    def __init__(self, args, max_seq_length, mode='x'):
        ...
        # Build LXRT Model
        self.model = VisualBertForLXRFeature.from_pretrained(args.huggingface+args.tokenizer,
            mode=mode
        )
...
class LXRTEncoderAttention(nn.Module):
    def __init__(self, args, max_seq_length, mode='x'):
        super().__init__()
        self.max_seq_length = max_seq_length

       
        from lxrt.modeling import LXRTFeatureExtractionAttention as VisualBertForLXRFeature, VISUAL_CONFIG
